    ...
    async function handleAddComment(e) {
        ...
        try {
            ...
            fetch(process.env.REACT_APP_EMAIL_API, {
                ...
                body: JSON.stringify({
                    to: "scitech-technologysupport@canberra.edu.au",
                    subject: `New comment on ticket ${request.ticket_no}`,
                    text: `${user.email} commented on ${request.ticket_no}:\n\n${newComment}\n\nView: http://localhost:3000/request/${request.ticket_no}`
                })
            });
        } catch (err) {
